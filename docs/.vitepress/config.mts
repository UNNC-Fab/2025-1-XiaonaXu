    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Week 4: CAD', link: '/assignments/week4.md' },
          { text: 'Week 5: electronics production', link: '/assignments/week5.md' },
          { text: 'Week 6: 3D scanning and printing', link: '/assignments/week6.md' },
